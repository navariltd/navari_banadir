...
#     make_work_order_for_finished_goods(doc, wo_list, default_warehouses)
#     make_work_order_for_subassembly_items(doc, wo_list, subcontracted_po, default_warehouses)
#     make_subcontracted_purchase_order(doc, subcontracted_po, po_list)
#     show_list_created_message("Work Order", wo_list)
#     show_list_created_message("Purchase Order", po_list)

#     if not wo_list:
#         frappe.msgprint(_("No Work Orders were created"))

# def make_work_order_for_finished_goods(doc, wo_list, default_warehouses):
#     items_data = get_production_items(doc)
...
# def make_work_order_for_subassembly_items(doc, wo_list, subcontracted_po, default_warehouses):
...
#         prepare_data_for_sub_assembly_items(doc, row, work_order_data)
#         work_order = create_work_order(work_order_data)
#         if work_order:
#             wo_list.append(work_order)

# def prepare_data_for_sub_assembly_items(doc, row, wo_data):
#     for field in [
#         "production_item",
#         "item_name",
#         "qty",
...
# def make_subcontracted_purchase_order(doc, subcontracted_po, purchase_orders):
...
#     wo.custom_seq_id = item.get("custom_seq_id")

#     try:
#         wo.flags.ignore_mandatory = True
#         wo.flags.ignore_validate = True
#         '''TODO: check how we can insert sequence id on those work orders'''
#         wo.insert()
#         return wo.name
